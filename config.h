 ...
 */
static const char * const BAR_FONT = "Terminus:size=12";

/* colors:
 * (see X(7) section "COLOR NAMES" for valid values)
 */
static const char * const WIN_BG_COLOR = "#1b202a";
static const char * const WIN_FS_COLOR = "#9aa4bd";
static const char * const SEL_COLOR    = "#9aa4bd";
static const char * const BAR_BG_COLOR = "#9aa4bd";
static const char * const BAR_FG_COLOR = "#1b202a";
